@extends('layouts.app')
@section('title', 'Property Self Employed Loan')
@section('content')
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Loan Against Property For Self-Employed Person</h4>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="referal_id" readonly
                                                        value="{{ Auth::id() }}" placeholder="Id" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" name="image_itr"
                                                        accept="image/*">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" name="image_rent_agreement"
                                                        accept="image/*">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" name="image_bank_statement" accept="image/*">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Business Registration Proof(GST / Trade Licence / MSME / Gumasta):</label>
                                                    <input type="file" class="form-control" name="image_proof"
                                                        accept="image/*">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Registery Papers:</label>
                                                    <input type="file" class="form-control" name="image_registry_papers"
                                                        accept="image/*">
                                                </div>
                                            </div>
                                        </div>
