@extends('layouts.app')
@section('title', 'Property Salaried Person Loan')
@section('content')
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Loan Against Property Form For Salaried Person</h4>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <fieldset>
                                    <div class="form-card text-start">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="pwd">Salary:</label>
                                                    <select class="form-select mb-3 shadow-none" name="salary_option">
                                                        <option selected="">Select Your Option</option>
