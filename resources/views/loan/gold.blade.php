                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Gold Loan Application Form</h4>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="gold_karat" placeholder="Gold Karat" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">Gold Weight: *</label>
                                                    <input type="text" class="form-control" name="gold_weight" placeholder="Gold Weight" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
