@extends('layouts.app')
@section('title', 'All Recharge Plan')
@section('content')
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex header-title justify-content-between">
                                <h5 class="card-title">All Recharge Plan</h5>
                                <a href="{{ route('recharge-plan.create') }}" class="btn btn-primary">Add Recharge Plan</a>
                            </div>
                        </div>
                        <div class="card-body">
                            @if (session('status'))
                                ...
                                <table id="datatable" class="table table-striped table_style" data-toggle="data-table">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($operators as $operator)
                                            @if ($operator->id == $rechargeplan->operator_id)
                                        @php
                                        ...
                                        @endforeach
                                            <tr>
                                                <td>{{ $count }}</td>
                                                <td>{{ $operator_name }}</td>
                                                <td>{{ $rechargeplan->circle }}</td>
                                                <td>{{ $rechargeplan->plancateogry->plan_category_name }}</td>
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip"
                                                            ...
                                                            href="{{ route('recharge-plan.destroy', $rechargeplan->id) }}">
                                                            <span class="btn-inner">
                                                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    stroke="currentColor">
